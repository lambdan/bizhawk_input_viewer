...
function check_buttons(input)
	...
	if input["B"] then
		forms.drawEllipse(pb, 220, 60, 20, 20, "yellow", "yellow")
	else
		forms.drawEllipse(pb, 220, 60, 20, 20, "yellow", "black")
	end

	if input["A"] then
		forms.drawEllipse(pb, 240, 40, 20, 20, "red", "red")
	else
		forms.drawEllipse(pb, 240, 40, 20, 20, "red", "black")
	end

	if input["Y"] then
		forms.drawEllipse(pb, 200, 40, 20, 20, "green", "green")
	else
		forms.drawEllipse(pb, 200, 40, 20, 20, "green", "black")
	end

	if input["X"] then
		forms.drawEllipse(pb, 220, 20, 20, 20, "blue", "blue")
	else
		forms.drawEllipse(pb, 220, 20, 20, 20, "blue", "black")
	end
